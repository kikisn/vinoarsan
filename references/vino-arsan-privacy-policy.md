...
Vino Arsan ("we," "our," or "us") operates this store and website, including all related information, content, features, tools, products and services (the "Services"). Vino Arsan is powered by Shopify, which enables us to provide the Services to you through our Buy Button integration and checkout functionality hosted at vino-arsan-2.myshopify.com.
...
This policy complies with the Republic Act No. 10173, also known as the Data Privacy Act of 2012 (DPA), and its Implementing Rules and Regulations (IRR).

**Please read this Privacy Policy carefully.** By using and accessing any of the Services, you acknowledge that you have read this Privacy Policy and understand the collection, use, and disclosure of your information as described herein. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
...
- **Financial information** including credit card, debit card, and financial account numbers, payment card information, financial account information, transaction details, form of payment (GCash, Maya, credit card, cash on delivery), payment confirmation and other payment details
- **Account information** including your username, password, security questions, preferences and settings (if you create an account)
...
- **Age verification information** including date of birth or government-issued ID details to verify you are 18 years or older (required for alcohol sales)
...
- **From Shopify** when you interact with our Buy Buttons or complete checkout on our Shopify-hosted pages
...
### 3.5 Age Verification (Legal Requirement for Alcohol Sales)
We are legally required to verify that all customers purchasing our wine products are 18 years of age or older in compliance with Philippine alcohol sale regulations. We use your age verification information solely for this compliance purpose.

### 3.6 Legal Reasons
We use your personal information to comply with applicable law or respond to valid legal process, including requests from law enforcement or government agencies (National Privacy Commission, Bureau of Internal Revenue), to investigate or participate in civil discovery, potential or actual litigation, or other adversarial legal proceedings, and to enforce or investigate potential violations of our terms or policies.

---

## 6. Age Verification for Alcohol Sales (Philippine Legal Requirement)

**Important:** Our products contain alcohol and are only available to individuals 18 years of age or older in compliance with Philippine law.

- We require age verification before completing any purchase
- We may request a valid government-issued ID for verification purposes
- Age verification information is used solely to confirm legal drinking age eligibility
- We reserve the right to refuse service to anyone who cannot provide adequate proof of legal drinking age
- Age verification data is handled in accordance with this Privacy Policy and the Data Privacy Act of 2012

## 7. Third Party Websites and Links

The Services may provide links to websites or other online platforms operated by third parties (including social media platforms like Facebook). If you follow links to sites not affiliated or controlled by us, you should review their privacy and security policies and other terms and conditions. 
...
## 5. Relationship with Shopify and Buy Button Integration

**Important:** Our e-commerce functionality is powered by Shopify through Buy Button integration. When you interact with our Buy Buttons or complete a purchase, you are also interacting with Shopify's services.

### How Our Buy Buttons Work
Our website (hosted on GitHub Pages) uses Shopify Buy Buttons embedded on our product pages. When you:
- Click "Add to Cart" on our website
- View your shopping cart
- Proceed to checkout

You are redirected to our Shopify-hosted checkout page at **vino-arsan-2.myshopify.com**, where Shopify collects and processes your personal information to complete your purchase.

### Shopify's Role as Service Provider and Data Controller
...
### Your Rights Regarding Shopify Data Processing
To learn more about how Shopify uses your personal information and any rights you may have, you can visit:
...
Depending on where you live, you may exercise certain rights with respect to your personal information through Shopify's Privacy Portal.
...
- **With Shopify, vendors and other third parties** who perform services on our behalf (e.g. IT management, payment processing, data analytics, customer support, cloud storage, fulfillment and shipping). When you click our Buy Buttons or complete checkout, your information is transmitted to and processed by Shopify at vino-arsan-2.myshopify.com.
...
- **With payment processors** including PayMongo for processing GCash, Maya, and credit card payments
- **With shipping and delivery services** for order fulfillment
...
Our website and Shopify checkout pages use cookies and similar technologies to enhance your experience and enable e-commerce functionality.

### Types of Cookies We Use
- **Essential Cookies:** Required for Buy Button functionality, shopping cart operation, and checkout process
- **Shopify Cookies:** Enables secure checkout, payment processing, and order management on vino-arsan-2.myshopify.com
- **Analytics Cookies:** Help us understand how visitors use our website and Shopify store
- **Marketing Cookies:** Facebook Pixel for tracking conversions and ad performance
- **Preference Cookies:** Remember your language and regional preferences

### Managing Cookies
You can control cookies through your browser settings. Note that disabling cookies may affect website functionality, prevent items from being added to your cart, and block your ability to complete purchases.
...
- **Encryption:** SSL/TLS encryption for data transmission on our website and Shopify checkout
- **Secure Payment Processing:** PCI-DSS compliant payment processors (PayMongo, Shopify Payments)
- **Access Controls:** Limited access to personal data on a need-to-know basis
- **Shopify Security:** Shopify maintains security measures for data processed through their platform

### Data Retention
How long we retain your personal information depends on different factors, such as whether we need the information to maintain your account, to provide you with Services, comply with legal obligations (including Philippine Bureau of Internal Revenue requirements), resolve disputes or enforce other applicable contracts and policies.

**Retention Periods:**
- **Order Information:** 10 years (Philippine tax compliance requirement per BIR regulations)
- **Marketing Consent:** Until you withdraw consent
- **Account Information:** Until you request deletion or as required by law
- **Payment Data:** Retained by payment processors per their policies and PCI-DSS requirements
...
- **Right to Be Informed:** You have the right to know how we collect, use, and share your personal data
...
- **Right to Erasure/Blocking:** You may request deletion or blocking of your personal data, subject to legal retention requirements (such as the 10-year BIR requirement)
- **Right to Rectification:** You may request correction of inaccurate personal information we maintain about you
- **Right to Data Portability:** You may request transfer of your data in a structured, commonly used format
- **Right to Lodge a Complaint:** You can file a complaint with the National Privacy Commission (see Section 17)
...
We will respond to your request in a timely manner as required under applicable law (within 30 days for Philippine DPA requests).
...
### 11.1 Opt-In
We will only send marketing emails if you have opted in to receive them.

### 11.2 Opt-Out
You can unsubscribe from marketing communications at any time by:
- Clicking the "unsubscribe" link in any marketing email
- Emailing us at [INSERT EMAIL]
- Updating your communication preferences in your account settings

### 11.3 Transactional Emails
You cannot opt out of essential transactional emails (order confirmations, shipping updates) as these are necessary for order fulfillment.

---

## 12. Third-Party Links

Our website may contain links to third-party websites (e.g., social media, partner sites). We are not responsible for the privacy practices of these external sites. We encourage you to review their privacy policies before providing any personal information.

---

## 13. Children's Privacy

Our products and services are not intended for individuals under 18 years of age. We do not knowingly collect personal information from minors. If we discover we have collected data from someone under 18, we will delete it immediately.

---

## 12. International Transfers

Please note that we may transfer, store and process your personal information outside the Philippines. Information you submit to the Services will be transmitted to and shared with Shopify as well as third parties that may be located in countries other than where you reside, in order to provide and improve the Services for you.
...
**Data Protection Officer:** [INSERT NAME IF DESIGNATED]

## 16. Legal Basis for Processing (Philippine Data Privacy Act)
...
- **Contract:** Processing is necessary to fulfill our contract with you (order fulfillment)
- **Legal Obligation:** Processing is necessary to comply with Philippine laws (age verification for alcohol sales, BIR tax compliance)
- **Legitimate Interests:** Processing is necessary for our legitimate business interests (fraud prevention, website security)

---

## 17. National Privacy Commission (Philippine Data Protection Authority)

If you wish to file a complaint or have concerns about our data practices, you may contact:
...
**This Privacy Policy is effective as of December 12, 2025.**

---

**Document Version:** 1.0  
**Prepared for:** Vino Arsan  
**Compliance:** Data Privacy Act of 2012 (RA 10173), Shopify Privacy Standards
